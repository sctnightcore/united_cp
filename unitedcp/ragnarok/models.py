...
class Login(models.Model):
    ...
    unban_time = models.IntegerField(default=0)
    ...
    character_slots = models.IntegerField(default=0)
    pincode = models.CharField(max_length=4, default='')
    pincode_change = models.IntegerField(default=0)
    master_account = models.ForeignKey(User, on_delete=models.DO_NOTHING)
...
class CartInventory(models.Model):
    ...
    nameid = models.ForeignKey(ItemDb, on_delete=models.DO_NOTHING, db_column='nameid', related_name='+')
    amount = models.IntegerField()
    equip = models.IntegerField()
    identify = models.SmallIntegerField()
    refine = models.IntegerField()
    attribute = models.IntegerField()
    card0 = models.ForeignKey(ItemDb, on_delete=models.DO_NOTHING, db_column='card0', related_name='card_id0')
    card1 = models.ForeignKey(ItemDb, on_delete=models.DO_NOTHING, db_column='card1', related_name='card_id1')
    card2 = models.ForeignKey(ItemDb, on_delete=models.DO_NOTHING, db_column='card2', related_name='card_id2')
    card3 = models.ForeignKey(ItemDb, on_delete=models.DO_NOTHING, db_column='card3', related_name='card_id3')
...
class AutotradeData(models.Model):
    char_id = models.ForeignKey(Char, on_delete=models.DO_NOTHING, to_field='char_id', db_column='char_id',
                                name='char_id')
    itemkey = models.ForeignKey(CartInventory, on_delete=models.DO_NOTHING)
    amount = models.IntegerField()
    price = models.IntegerField()
...
class GuildCastle(models.Model):
    ...
    guild_id = models.ForeignKey(Guild, on_delete=models.DO_NOTHING, name='guild_id', to_field='guild_id',
                                 db_column='guild_id')
...
class VendingItems(models.Model):
    vending_id = models.ForeignKey(Vendings, on_delete=models.DO_NOTHING, to_field='id', db_column='vending_id')
    index = models.SmallIntegerField()
    cartinventory_id = models.ForeignKey(CartInventory, on_delete=models.DO_NOTHING, to_field='id',
...
class CharWoeLog(models.Model):
    time = models.DateTimeField()
    killer = models.CharField(max_length=25)
    killer_id = models.ForeignKey(Char, on_delete=models.DO_NOTHING, db_column='killer_id', related_name='killer')
    killed = models.CharField(max_length=25)
    killed_id = models.ForeignKey(Char, on_delete=models.DO_NOTHING, db_column='killed_id', related_name='killed')
    map = models.CharField(max_length=11)
    skill = models.IntegerField()
